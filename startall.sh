...
conky -c ~/.config/conky/lux-hud/lux-todo.conf &
conky -c ~/.config/conky/lux-hud/lux-disp.conf &
conky -c ~/.config/conky/lux-hud/lux-log.conf &
conky -c ~/.config/conky/lux-hud/lux-clock.conf &
conky -c ~/.config/conky/lux-hud/lux-weather.conf &
conky -c ~/.config/conky/lux-hud/lux-mellowplayer.conf &
